...
export default function Signup(){
    ...
    return(<div className="flex h-screen w-full justify-center items-center bg-[#050B18]">
        <div className="w-[400px] h-[250px] border-1 border-white rounded-md">
          <div className="flex justify-center font-bold text-white py-3  text-lg">Signin</div>
          ...
          <div className="text-white"> Don't have account,<b className="hover:text-blue-500"><button classname="bg-transparent" onClick={()=>{navigate('/signup'}}>CREATE ONE</a></b> </div>
          </div>
    </div>)
}
